...
/*
 * Design Pattern => é um conjunto com as melhores práticas para POO.
 *  - DTO (Data Transfer Object) => é um pattern, que descreve as melhores práticas para representar uma classe de um
 *  diagrama em uma programação.
 *  Regras:
 *  1- TODOS os atributos devem ser privados
 *  2- CADA atributo, deve possuir INDIVIDUALMENTE um método para set e outro metodo para get.
